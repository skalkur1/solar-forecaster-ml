...
PV forecasting project that predicts solar output at 1-12 hour horizons for select sites.
...
**
Use: python extract_pvdaq_data.py
**
...
**
Use: python extract_hrrr_data.py
**
...
**
Use: python test_lstm.py <trained_model_dir>
Ex:  python test_lstm.py lstm_main
**
